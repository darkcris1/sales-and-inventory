...
class Invoice(models.Model):
    ...
    price_per_item = models.FloatField(verbose_name=('Price Per Item (php)'))
    quantity = models.FloatField(default=0.00)
    shipping = models.FloatField(verbose_name=('Shipping and handling'))
    total = models.FloatField(verbose_name=('Total Amount (php)'))
    grand_total = models.FloatField(verbose_name=('Grand total (php)'))
